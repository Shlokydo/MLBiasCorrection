...
class Lorenz96:
  ...
  """
  def __init__(self, n = 40, f = 8, dt = 0.005, init_x = None , amp_const_bias = 0 ):
    self.n = n
    self.f = f
    self.dt = dt
...
class Lorenz96_add:
  ...
  This class provides the Lorenz96 model equations and the 4th-order Runge-Kutta solver.
  """
  def __init__(self, n = 40, f = 8, dt = 0.005, init_x = None , amp_add_bias = 0 , amp_add_bias_2 = None , mode = None ):
    self.n = n
    self.f = f
    self.dt = dt
